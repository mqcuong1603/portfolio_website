  ...
  return (
    <footer className="bg-muted/50 border-t border-border">
      ...
      <div className="fixed bottom-8 right-8">
        <a
          href="#home"
          className="w-12 h-12 bg-primary text-white rounded-full flex items-center justify-center shadow-lg hover:bg-primary-dark hover:shadow-xl transform hover:scale-110 transition-all duration-200"
        >
          <svg
            className="w-5 h-5"
            fill="none"
