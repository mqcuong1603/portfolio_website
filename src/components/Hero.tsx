        ...
        <div className="space-y-8">
          ...
          <div className="animate-fade-in-up delay-400">
            <h2 className="text-2xl sm:text-3xl lg:text-4xl font-semibold text-secondary">
              I&apos;m a{" "}
              <span className="text-primary border-r-2 border-primary">
                {text}
              </span>
            </h2>
          </div>
          ...
          <div className="animate-fade-in-up delay-600">
            <p className="text-lg sm:text-xl text-secondary max-w-3xl mx-auto leading-relaxed">
              ...
              design with powerful functionality. Let&apos;s build something
              amazing together.
            </p>
          </div>
          ...
          <div className="animate-fade-in-up delay-800 flex flex-col sm:flex-row gap-4 justify-center">
            <a
              href="#projects"
              className="inline-flex items-center px-8 py-4 bg-primary text-white font-semibold rounded-full hover:bg-primary-dark transform hover:scale-105 transition-all duration-200 shadow-lg hover:shadow-xl"
            >
              View My Work
              <svg
            ...
            <a
              href="#contact"
              className="inline-flex items-center px-8 py-4 border-2 border-primary text-primary font-semibold rounded-full hover:bg-primary hover:text-white transform hover:scale-105 transition-all duration-200"
            >
              Get In Touch
            </a>
          </div>
          ...
          {/* Social Links */}
          <div className="animate-fade-in-up delay-1000 flex justify-center space-x-6 pt-8">
            <a
